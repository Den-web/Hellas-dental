				...
				<td style="width: 110px; padding: 0; vertical-align: top;" title="">
					<div style="width: 100%;">
						...
						<div style="padding: 15px 0 0 0;">
							...
							<div class="nishka" style="margin-bottom: 5px;">
							<input style="margin: 4px 1px 4px 0;" class="radio" id="<?=$this->get_field_id('taxonomy'); ?>" title="Displays all Links in the current Page/Post. Combine with the <span class='green'>Custom Container ID</span> on the right for displaying links from specified HTML container."
...
//									echo '<option id="auli_55"'; if($authors_limit==''){echo ' selected';}; echo ' value="">all</option>';
					...
					<label style="width: 173px; margin: 2px 0 0 0; line-height: 13px;" title="Leaving this field empty will load ALL current post/page links, which may include navigation links, meta tags, comments etc. If you want to use the links from a specific HTML tag (div, table, ul etc.) enter its ID." for="<?=$this->get_field_id('conid'); ?>">
						Custom Container ID 
						<input style="margin-top: 0; width: 173px;"
	...
	<div class="section_content">
		<div style="display: inline-block; padding-bottom: 2px;">
			...
			<div class="thin-spacer"></div>
			<label style="margin: 1px 3px 0 0;" title="If set to a number, the selected tag will move to the front in this many milliseconds before activating." for="<?=$this->get_field_id('click_to_front'); ?>">
				Click to Front Time
				<br>
			...
			<label style="margin: 1px 33px 0 0;" title="Animation delay in milliseconds for when the page is being scrolled. Applies to all TagCanvas instances on the page." for="<?=$this->get_field_id('scroll_pause'); ?>">
				Scroll Pause
				<br>
