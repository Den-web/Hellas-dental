			...
			<?php 
				switch($taxonomy){
					case "links":
						...
						break;
					case "menu":
						$args = array ('menu' => $menu); wp_nav_menu($args);
						break;
					case "recent_posts":
					...
					case "pp_links":
						...
						break;
					case "post_tag":
						$args = array ('number' => $tags, 'taxonomy' => $taxonomy); wp_tag_cloud($args);
						break;
					case "category":
						$args = array ('number' => $categories, 'taxonomy' => $taxonomy); wp_tag_cloud($args);
						break;
				}
			?>	
        </div>	
		<div id='canvas_wrap_<?= $inst_id; ?>'>
